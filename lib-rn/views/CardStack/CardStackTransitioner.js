...
class CardStackTransitioner extends React.Component {
  ...
  render() {
    ...
    const splitPaneToSplitPaneNav = this.props.isMultiPaneEligible && currentScene.leftSplitPaneComponent && previousScene.leftSplitPaneComponent;
    ...
    return <Transitioner configureTransition={animation} navigation={this.props.navigation} render={this._render} onTransitionStart={this.props.onTransitionStart} onTransitionEnd={this.props.onTransitionEnd} onFlipStart={() => {
      this.setState({
        isFlipFrom: true,
        isFlipTo: false
      });
  ...
  _render = props => {
    ...
    return <CardStack screenProps={screenProps} headerMode={headerMode} mode={mode} router={router} cardStyle={cardStyle} transitionConfig={transitionConfig} {...props} headerComponent={this.props.headerComponent} routeActions={this.props.routeActions} isIOS={this.props.isIOS} isAndroid={this.props.isAndroid} isMultiPaneEligible={this.props.isMultiPaneEligible} statusBarSize={this.props.statusBarSize} trackingActions={this.props.trackingActions} hasModal={this.props.hasModal} openDrawer={this.props.openDrawer} handleBackAction={this.props.handleBackAction} handleNavigate={this.props.handleNavigate} modals={this.props.modals} isFlipTransition={isFlipTransition(currentScene)} isFlipFrom={this.state.isFlipFrom} isFlipTo={this.state.isFlipTo} />;
  };
}
